...
"""autogenerated by genpy from mujoco_ros_msgs/StepActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class StepActionFeedback(genpy.Message):
  _md5sum = "9517fe5a494543db55011d3ba622ed20"
  _type = "mujoco_ros_msgs/StepActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mujoco_ros_msgs/StepFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = mujoco_ros_msgs.msg.StepFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = mujoco_ros_msgs.msg.StepFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.steps_left,) = _get_struct_H().unpack(str[start:end])
      return self
