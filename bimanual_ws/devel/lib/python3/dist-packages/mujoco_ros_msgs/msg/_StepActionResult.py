...
"""autogenerated by genpy from mujoco_ros_msgs/StepActionResult.msg. Do not edit."""
import codecs
import sys
...
class StepActionResult(genpy.Message):
  ...
  _type = "mujoco_ros_msgs/StepActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mujoco_ros_msgs/StepResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = mujoco_ros_msgs.msg.StepResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mujoco_ros_msgs.msg.StepResult()
