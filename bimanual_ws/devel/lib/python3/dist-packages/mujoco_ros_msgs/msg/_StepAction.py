...
"""autogenerated by genpy from mujoco_ros_msgs/StepAction.msg. Do not edit."""
import codecs
import sys
...
class StepAction(genpy.Message):
  _md5sum = "381d9f5d22e2d55888fe76022dd60cf4"
  _type = "mujoco_ros_msgs/StepAction"
...
"""
  ...
  _slot_types = ['mujoco_ros_msgs/StepActionGoal','mujoco_ros_msgs/StepActionResult','mujoco_ros_msgs/StepActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = mujoco_ros_msgs.msg.StepActionGoal()
      if self.action_result is None:
        self.action_result = mujoco_ros_msgs.msg.StepActionResult()
      if self.action_feedback is None:
        self.action_feedback = mujoco_ros_msgs.msg.StepActionFeedback()
    else:
      self.action_goal = mujoco_ros_msgs.msg.StepActionGoal()
      self.action_result = mujoco_ros_msgs.msg.StepActionResult()
      self.action_feedback = mujoco_ros_msgs.msg.StepActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_H3I().pack(_x.action_goal.goal.num_steps, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.steps_left
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.num_steps, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_H3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.steps_left,) = _get_struct_H().unpack(str[start:end])
      return self
