...
class ReloadRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ReloadRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ReloadRequest
    let len;
    let data = new ReloadRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReloadRequest(null);
...
class ReloadResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ReloadResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ReloadResponse
    let len;
    let data = new ReloadResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReloadResponse(null);
...
module.exports = {
  ...
  md5sum() { return 'c5610c6a70905083203e69841b7db0de'; },
  datatype() { return 'mujoco_ros_msgs/Reload'; }
};
