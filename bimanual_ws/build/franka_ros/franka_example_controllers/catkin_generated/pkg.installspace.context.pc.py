...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_example_controllers;/uolstore/home/users/sc23j3k/.local/lib/libfranka.so.0.8.0".split(';') if "-lfranka_example_controllers;/uolstore/home/users/sc23j3k/.local/lib/libfranka.so.0.8.0" != "" else []
