...
#rosrun allegro_hand_description allegro_hand_description_$hand.xacro -o #allegro_hand_description_$hand.urdf

#rosrun allegro_hand_description allegro_hand_description_$hand.urdf 
